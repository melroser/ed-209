...
- [ ] 1. Backend core — SDN client, evidence decomposer, fusion, decision, API endpoints
  ...
  - [ ] 1.2 Implement SDN client function `query_sdn(name: str) -> tuple[list[dict], bool]`
  ...
  - [ ] 1.3 Implement evidence decomposer `decompose_evidence(top_match, all_matches, screened_country, screened_type) -> dict[str, Opinion]`
  ...
  - [ ] 1.4 Implement fusion engine and conflict scoring
